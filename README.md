...
[leopard](http://GJoker.github.io) 是一个简洁的博客模板，如果你也喜欢请 Star ，你的 Star 是我持续更新的动力, 谢谢 😄.
...
> $ git clone https://github.com/GJoker/GJoker.github.io.git

或者直接[下载博客](https://github.com/GJoker/GJoker.github.io/archive/master.zip)   

进GJoker.github.io/ 目录下， 开启本地服务 
...
如果在部署博客的时候发现问题，可以直接在[Issues](https://github.com/GJoker/GJoker.github.io/issues)里面提问。        
...
如果你只想要我博客里的头像效果，你只需要拿 GJoker.github.io/_includes/side-panel.html 文件里面 `头像效果` 和 GJoker.github.io/css/main.css 里面最后面 `头像效果` 部分就行了。
